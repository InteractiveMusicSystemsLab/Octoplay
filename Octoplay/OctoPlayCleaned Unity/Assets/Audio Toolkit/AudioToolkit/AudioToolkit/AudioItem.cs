...
public class AudioCategory
{
    ...
    public int _GetIndexOf( AudioItem audioItem )
    {
...
public class AudioItem
{
    ...
    public enum LoopMode
    {
        ...
        /// <summary>
        /// Play as many sub-items as specified by <see cref="loopSequenceCount"/> and loop the last on picked. Specify zero to 
