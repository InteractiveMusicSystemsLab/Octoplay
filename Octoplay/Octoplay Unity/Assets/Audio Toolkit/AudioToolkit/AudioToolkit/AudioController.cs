...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    /// </summary>
    public const string AUDIO_TOOLKIT_VERSION = "6.1";
	...
	public static float lastSignal=0f;
    /// <summary>
    ...
    public AudioCategory _GetCategory( string name )
    {
    ...
    public List<AudioController> _additionalAudioControllers;
    ...
    protected static AudioSubItem[ ] _ChooseSubItems( AudioItem audioItem, AudioPickSubItemMode pickMode, AudioObject useExistingAudioObj )
    {
        ...
        if ( arraySize > 1 )
        {
            ...
            case AudioPickSubItemMode.StartLoopSequenceWithFirst:
                if ( Time.time-lastSignal<=1.1f)
                {
                    chosen = ( lastChosen + 1 ) % arraySize;
					Debug.Log ("Triggered " + useExistingAudioObj + " at: " + lastSignal);
                ...
                {
                    chosen = 0;
					Debug.Log ("Second Triggered  " + useExistingAudioObj + " at: " + lastSignal);
					lastSignal=Time.time;
