...
abstract public class EditorEx : Editor
{
    ...
    protected int Popup( string label, int selectedIndex, string[] content, string tooltip = null )
    {
        return PopupWithStyle( label, selectedIndex, content, stylePopup, tooltip );
    }

    protected int PopupWithStyle( string label, int selectedIndex, string[] content, GUIStyle style, string tooltip = null )
    {
        EditorGUILayout.BeginHorizontal();
        //GUILayout.Label( label, styleLabel );
        EditorGUILayout.LabelField( new GUIContent( label, tooltip ), labelFieldOption );
...
public class AudioController_Editor : EditorEx
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if ( categoryFoldout = EditorGUILayout.Foldout( categoryFoldout, "Category Settings", foldoutStyle ) )
        {
            ...
            int newCategoryIndex = PopupWithStyle( "Category", currentCategoryIndex, GetCategoryNames(), popupStyleColored );
